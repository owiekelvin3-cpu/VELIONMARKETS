...
>(({ className, sideOffset = 8, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        "z-[140] min-w-[10rem] overflow-hidden rounded-xl border border-border bg-surface-elevated p-1 text-foreground shadow-[0_16px_48px_rgba(0,0,0,0.45)] animate-in fade-in-0 zoom-in-95",
        className
      )}
      {...props}
    />
