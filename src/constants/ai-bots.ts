...
export const AI_BOTS: AIBot[] = [
  {
    ...
    simpleDescription: "Best for beginners — slow and steady growth.",
  ...
  },
  {
    ...
    simpleDescription: "Earns more each hour — good when you want faster growth.",
    winRate: 100,
    monthlyReturn: "+31.2%",
  ...
  },
  {
    ...
    simpleDescription: "Highest earnings — for people comfortable taking more risk.",
    winRate: 100,
    monthlyReturn: "+47.8%",
