          ...
          <FadeIn className="mx-auto max-w-md">
            <GlassCard>
              <form onSubmit={handleVerify} className="space-y-4">
                <div>
                  <Label htmlFor="certId" className="text-muted">Certificate ID</Label>
                  ...
                  {result ? (
                    <div className="rounded-xl border border-emerald/20 bg-emerald/5 p-4">
                      ...
                      <div className="mt-3 space-y-1 text-sm text-muted">
                        <p><strong className="text-foreground">Holder:</strong> {result.holder_name}</p>
                        <p><strong className="text-foreground">Type:</strong> {result.type}</p>
                        <p><strong className="text-foreground">Issued:</strong> {result.issue_date}</p>
                        <Badge variant="success" className="mt-2">Authentic</Badge>
                      </div>
                    </div>
                  ) : (
